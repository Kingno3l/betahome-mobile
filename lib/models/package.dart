...
class Package {
  ...
  Package(this._id, this._name, this._description, this._color, this._price,
      this._items);

  factory Package.fromJson(dynamic json) {
    return Package(json['_id'], json['name'], json['description'],
        json['color'], json['price'], json['items']);
  }
